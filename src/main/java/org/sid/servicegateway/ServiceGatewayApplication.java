package org.sid.servicegateway;
...
public class ServiceGatewayApplication {
		...
		return builder.routes()
				.route(r ->r.path("/publicCountries/**")
						.filters(f->f
								...
								.addRequestHeader("x-rapidapi-key", "5fc76e1d3cmsh307dbec95af7e72p152ff2jsn7c18dad66671")
				...
				.route(r ->r.path("/muslim/**")
						...
						.uri("https://muslimsalat.p.rapidapi.com").id("r1"))
				.build();
	}
	@Bean
	...
	class CircuitBreakerRestController{
		...
		public Map<String, String> countries (){
			...
			data.put("countries", "Maroc, Algerie, Tunisie, Ivory Cost, .........");
			return data;
		}
